//
//A maths companion for primary/high school students
...
void frac_converter(int num1, int num2);
...
int main (void) {
        ...
        while (scanf ("%s", command) != NULL) {
                ...
                if (strcmp (command, HIGHEST_COMMON_FACTOR) == 0) {
                        ...
                        printf("The lowest common multiple of %d and %d is %d", num1, num2, lowest_common_multiple(num1, num2));
                        ...
                        printf ("What number would you like the factors of? ");
                        scanf ("%d", &num1);
                        ...
                        printf ("'factors' to find the factors of a number\n");
                        ...
                        printf ("'fconv' to convert a fraction to dec and percentage\n");
                ...
                } else if (strcmp (command, FRAC_CONVERT) == 0) {

                        int num1, num2 = 0;

                        printf ("Enter your fraction in the form a/b: ");

                        scanf ("%d/%d", &num1, &num2);

                        frac_converter(num1, num2);

                } else  { //this is to replace the else which didn't work

                        printf ("Invalid command. Use 'help' to see list of comamnds.\n");
...
void simplify_surd() {
        ...
        double surd = 0;
        double outside_num = 1;
        double counter = 1;

        printf ("Enter the number underneath the square root: ");
        scanf ("%lf", &surd);
...
void frac_converter(int num1, int num2) {
        ...
        printf ("%d/%d as a decimal is %.2lf and as a percentage is %.2lf%\n ", num1, num2, decimal, percentage);
